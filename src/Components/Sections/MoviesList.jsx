...
const MoviesList = () => {
  ...
  return (
    ...
    max-sm:via-[#e8e6e3]/40 max-sm:dark:via-[#0b0b0b]/40"
        ...
        <div ref={ref} className="flex items-center snap-x gap-4 overflow-x-hidden no-scrollbar z-10">
...

          {
            mockMovieImage.map((item,index) => (
                <div key={index} className="shrink-0 group snap-center sm:snap-start w-[230px] sm:w-[300px] cursor-pointer overflow-hidden">
